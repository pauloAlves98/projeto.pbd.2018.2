...
public class EncriptaDecriptaRC4 {   
	...
	private static String chave = "pbd2018";
	public static EncriptaDecriptaRC4 rc4 = new EncriptaDecriptaRC4(chave);
	
	public static void main(String[] args) {
			char[] textoCriptografado = 
					rc4.criptografa("12345678".toCharArray());
	...
	private EncriptaDecriptaRC4(String key) {
		try {
			setKey(key);
